...
const requiredFiles = [
  'dist/vanilla-tables.js',
  'dist/vanilla-tables.cjs',
  'dist/vanilla-tables.min.js',
  'dist/vanilla-tables.css'
];
...
function runPackCheck() {
  ...
  for (const expected of [
    'package/dist/vanilla-tables.js',
    'package/dist/vanilla-tables.cjs',
    'package/README.md'
  ]) {
